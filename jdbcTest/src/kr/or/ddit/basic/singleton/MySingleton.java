...
/*
 * singleton패턴 ==> 객체가 1개만 만들어지게 하는 방법(외부에서 new 명령을 사용하지 못하게 한다.)
 * 
 * - 사용이유
 * 1) 메모리 낭비 방비
 * 2) 데이터의 공유가 쉽다
 ...
 * 2) 모든 생성자의 접근제한자를 private으로 변경한다.
...
public class MySingleton {
	...
	public static MySingleton getInstance() {
		// 1번의 변수가 null이면 객체를 생성하여 1번 변수에 저장한다
	...
	public void displayTest() {
		System.out.println("싱글톤 클래스에서 출력하는 내용입니다.");
	}
}
