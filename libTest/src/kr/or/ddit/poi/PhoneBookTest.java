...
추가 조건 ) 
1) '6. 데이터 Excel로 저장' 메뉴를 추가하고 구현하시오.
	(저장 파일명 : 'd:/d_other/phoneBook.xlsx')
2) 이 프로그램이 시작할  때 저장 된 Excel파일이 있으면
  	그 파일을 읽어와 Map에 셋팅한다.
3) 프로그램을 종료할 때 변경된 사항이 있으면 저장 후 종료되도록 한다.
...
//		phoneBookMap.put(name , new Phone(name, tel, addr));
		...
		File file = new File("d:/d_other/phoneBook.xls");
...
//		phoneBookMap.put(name, p);
	...
	private int displayMenu() {
		...
		System.out.println("6. 데이터 Excel로 저장");
